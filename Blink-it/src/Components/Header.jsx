        ...
        <div className={`toggleButton ${show && "on"}`}>
          ...
          {cart.length > 0 && (
            <>
              ...
              <div className="products">
                <p className="line">Cancellation Policy</p>
                <p className="order">Orders cannot be cancelled once packed for delivery. In case of unexpected delays, a refund will be provided, if applicable.</p>
              </div>
